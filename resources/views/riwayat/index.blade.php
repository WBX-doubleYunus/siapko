                                ...
                                <div class="col-lg-12">
                                    <form action="" class="form-inline">
                                        <div class="form-group">
                                            <label for="tanggal" class="mr-3">Tanggal</label>
                                            <input type="date" class="form-control" name="tanggal" name="tanggal" required>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            const table = $('table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.is_riwayat = true;
                        d.tanggal_filter = $('input[name="tanggal"]').val();
                    },
                    method: 'GET'
                },
                columns: [
